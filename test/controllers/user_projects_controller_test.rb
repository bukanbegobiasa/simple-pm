...
class UserProjectsControllerTest < ActionController::TestCase
  ...
  test "should create user_project" do
    assert_difference('UserProject.count') do
      post :create, user_project: { project: @user_project.project, role_id: @user_project.role_id, user_id: @user_project.user_id }
    end
  ...
  test "should update user_project" do
    patch :update, id: @user_project, user_project: { project: @user_project.project, role_id: @user_project.role_id, user_id: @user_project.user_id }
    assert_redirected_to user_project_path(assigns(:user_project))
  end
